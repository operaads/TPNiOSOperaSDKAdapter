...
@implementation ATSafeThreadArray_OP {
...
- (BOOL)isEqualToArray:(NSArray *)otherArray {
    ...
    if ([otherArray isKindOfClass:ATSafeThreadArray_OP.class]) {
        ATSafeThreadArray_OP *other = (id)otherArray;
        BOOL isEqual;
...
- (BOOL)isEqual:(id)object {
    ...
    if ([object isKindOfClass:ATSafeThreadArray_OP.class]) {
        ATSafeThreadArray_OP *other = object;
        BOOL isEqual;
        pthread_mutex_lock(&_mutex_lock);
        pthread_mutex_lock(&(other->_mutex_lock));
